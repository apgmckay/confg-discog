module "app" {
  ...
  confg_discog_config_file     = var.confg_discog_config_file     # "../../../confd/conf.d/myconfig.toml"
  confg_discog_app_config_file = var.confg_discog_app_config_file # "../../../confd/conf.d/myconfig.sh"
